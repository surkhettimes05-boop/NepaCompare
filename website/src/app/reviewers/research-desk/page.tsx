...
export default function ReviewerPage() {
  const schema = { '@context': 'https://schema.org', '@type': 'Organization', '@id': 'https://www.khaacho.com/reviewers/research-desk#organization', name: 'Khaacho Research Desk', url: 'https://www.khaacho.com/reviewers/research-desk', parentOrganization: { '@id': 'https://www.khaacho.com#organization' }, description: 'The internal source and factual-review function for Khaacho insurance content.' };
